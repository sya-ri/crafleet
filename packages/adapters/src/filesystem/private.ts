...
$existing = [System.IO.Directory]::GetAccessControl($env:CRAFLEET_PRIVATE_DIRECTORY, [System.Security.AccessControl.AccessControlSections]::Owner)
...
[System.IO.Directory]::SetAccessControl($env:CRAFLEET_PRIVATE_DIRECTORY, $acl)
`;

const ensurePrivateFileScript = `
$ErrorActionPreference = 'Stop'
$sid = [System.Security.Principal.WindowsIdentity]::GetCurrent().User
$existing = [System.IO.File]::GetAccessControl($env:CRAFLEET_PRIVATE_FILE, [System.Security.AccessControl.AccessControlSections]::Owner)
$owner = $existing.GetOwner([System.Security.Principal.SecurityIdentifier])
...
$acl.AddAccessRule($rule)
[System.IO.File]::SetAccessControl($env:CRAFLEET_PRIVATE_FILE, $acl)
`;

const assertPrivateFileScript = `
$ErrorActionPreference = 'Stop'
$sid = [System.Security.Principal.WindowsIdentity]::GetCurrent().User
$acl = [System.IO.File]::GetAccessControl($env:CRAFLEET_PRIVATE_FILE, [System.Security.AccessControl.AccessControlSections]::Access -bor [System.Security.AccessControl.AccessControlSections]::Owner)
