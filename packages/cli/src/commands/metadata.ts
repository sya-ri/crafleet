...
export const COMMAND_POLICIES: Readonly<Record<string, CommandPolicy>> = {
    ...
    addons: policy("read", "multiple"),
    "addons list": policy("read", "multiple"),
    "addons info": policy("read", "multiple"),
    "addons add": policy("change", "multiple"),
    "addons update": policy("change", "multiple"),
    "addons remove": policy("change", "multiple"),
